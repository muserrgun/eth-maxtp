...
set_property PACKAGE_PIN L18 [get_ports ref_clk_clk_p]
...
# RGMII timing constraints live in eth_port_1g_timing.xdc, processed LATE so
# that the PS and clk_wiz clocks exist before they are referenced.
